      ...
      if (move === "paper") {
        return <div className="flex h-screen w-screen">
          ...
          <div className="h-screen w-screen flex flex-col items-center justify-center">
            ...
            <p className="text-7xl text-white font-bold font-sans">{score2} - <span className="text-green-600">{score1}</span></p>
          </div>
          </div>}
      ...
      if (move === "paper") {
        return <div className="flex h-screen w-screen">
          ...
          <div className="h-screen w-screen flex flex-col items-center justify-center">
            ...
            <p className="text-7xl text-white font-bold font-sans">{score2} - <span>{score1}</span></p>
          </div>
        </div>}
      else if (move === "scissors") {
        return <div className="flex h-screen w-screen">
        ...
        <div className="h-screen w-screen flex flex-col items-center justify-center">
          <p className="text-7xl text-white font-bold font-sans">YOU TIE</p>
          <p className="text-7xl text-white font-bold font-sans">{score2} - {score1}</p>
        </div>
      </div>}
      else {
        return <div className="flex h-screen w-screen">
    ...
    if (result === "win") {
      if (move === "paper") {
        return <div>
          ...
          <div style={{bottom: 165}} className="flex flex-col justify-center h-screen items-center">
    ...
    if (move === "paper") {
      return <div>
        ...
        <div style={{bottom: 165}} className="flex flex-col justify-center h-screen items-center">
          ...
          <div className="flex justify-center">
            <p className="text-6xl text-white font-bold font-sans">{score2} - {score1}</p>
          </div>
        </div>
      </div>
    }
