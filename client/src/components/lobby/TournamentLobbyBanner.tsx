...
const TournamentLobbyBanner = ({tournamentCode, qrCode}:TournamentLobbyBannerProps) => {
return (<div className="w-full flex flex-row justify-start items-center py-4 px-5 gap-10">
    <div className="w-80">
        <DisplayLogo />
    </div>
