...
function DuelInProgressAnimation() {
  ...
  return (
    <div className="flex">
      <div className="z-0 animate-customping [--customping-delay:100ms] opacity-0 text-[#E943E9] text-[130px] font-bold absolute inset-0 flex items-center justify-center">
        <p>ROCK</p>
      </div>
      <div className="z-0 animate-customping [--customping-delay:1s] opacity-0 text-[#65DBBB] text-[130px] font-bold absolute inset-0 flex items-center justify-center">
        <p>PAPER</p>
      </div>
      <div className="z-0 animate-customping2 [--customping2-delay:1.9s] opacity-0 absolute inset-0 flex items-center justify-center">
      ...
      <div className="z-20 animate-customping3 [--customping3-delay:2.35s] opacity-0 text-white text-[130px] font-bold absolute inset-0 flex items-center justify-center">
