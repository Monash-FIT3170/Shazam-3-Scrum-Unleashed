  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-center items-center mt-20">
        <ButtonComponent linkPath={JOIN_GAME_PATH} text={"JOIN GAME"} />
      ...
      <div className="flex flex-col justify-center items-center mt-20 text-white text-2xl font-semibold block lg:hidden">
        {" "}
        {/* Increased mt-10 to mt-20 */}
