...
const MatchLossScreen = ({playerScore = 2, opponentScore = 3, playerName = "SPONGEBOB", opponentName = "PATRICK", spectatorCount = 32}: MatchLossScreenProps) => {
    return (
        <div>
            ...
            <div className='fixed top-[10%] mx-auto max-w-max inset-x-0 scale-[0.85] sm:scale-[0.85] md:scale-[0.875] lg:scale-[0.90]'>
            ...
            <div className='text-white font-bold text-6xl fixed top-[51%] mx-auto max-w-max inset-x-0'>
                <h1>{playerScore} - <span className='text-[#FF5959]'>{opponentScore}</span></h1>
            </div>
            <div className='text-white font-bold text-2xl md:text-3xl fixed top-[66%] mx-auto max-w-max inset-x-0'>
                <p>YOU AND YOUR FOLLOWERS WILL NOW FOLLOW <span className='text-[#FFC700]'>{opponentName}</span>!</p>
            </div>
...
export default MatchLossScreen;