  ...
  return (
    <div>
      ...
      <div className="hidden md:block">
        <StarsInfo playerName={opponentName} score={opponentScore} isOpponent={true} />
      </div>
      ...
      <div className={
        ...
        <img src={isWin ? plainTrophy : cross} alt={isWin ? "PlainTrophy" : "RedCross"} />
      </div>
      ...
      <div className="text-white font-bold text-2xl md:text-3xl fixed top-[66%] mx-auto max-w-max inset-x-0">
        {isWin ? <p><span className="text-[#FFC700]">{opponentName}</span> AND THEIR FOLLOWERS WILL NOW FOLLOW YOU!</p> 
      ...
      <div className="hidden md:block">
        <StarsInfo playerName={playerName} score={playerScore} isOpponent={false} />
      </div>
      <div className="hidden md:block">
