...
const TournamentLobby = () => {
    ...
    const [tournamentWinner, setTournamentWinner] = useState<string | undefined>(undefined);
    ...
    return (
        <div>
            {tournamentWinner !== undefined ? <TournamentWin playerName={tournamentWinner}/> :
                <div>
                    {tournamentStarted ? <TournamentBracketBanner/> :
