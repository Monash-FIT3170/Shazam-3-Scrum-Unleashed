...
export class TournamentManager {
  ...
  public getBracket(round: number): Array<Player> {
  ...
  private fillWithBots(players: Array<Player>) {
  ...
  private shufflePlayers(players: Array<Player>): Array<Player> {
